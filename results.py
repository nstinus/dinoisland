...
if __name__ == "__main__":
    ...
    print "%-30s    %4s    %7s  %15s    %7s    %7s    %7s" % ("version", "N#", "max", "date", "mean", "std", "median")
    lines = list()
    for version, runs in RUNS.iteritems():
        ...
        lines.append("%-30s    %4d    %7d  %15s    %7.0f    %7.0f    %7.0f" % (version, N, M.score, M.date, round(avg), round(stddev), round(med)))
